...
import com.turkcell.rencar_pair.ui.theme.NavInactiveDark
import com.turkcell.rencar_pair.ui.theme.NavInactiveLight
...
fun RencarBottomNavigation(
    ...
    val inactiveColor = if (isDark) NavInactiveDark else NavInactiveLight
